...
/**
 * Abstract magento csv product processor
 *
 ...
 */
abstract class AbstractProductToMagentoCsvProcessor extends AbstractProcessor
{
    ...
    protected function beforeExecute()
    {
        ...
        $this->globalContext = array_merge(
            ...
            [
                ...
                'userCategoryMapping'      => $this->categoryMappingMerger->getMapping(),
